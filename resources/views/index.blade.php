        ...
        <div class="wrapper">
            <div class="sidebar">
                <div class="sidebar-header">
                    <img src="img/asim.jpg" alt="Image">
                </div>
            ...
            <div class="content">
                ...
                <div class="header" id="header">
                    <div class="content-inner">
                        ...
                        <h1>Muhammad Asim</h1>
                        <h2></h2>
                        <div class="typed-text">Web Developer, Back End Developer, Php laravel Developer, Wordpress Designer</div>
                    </div>
                </div>
                <!-- Header End -->
                    ...
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 col-lg-7">
                                <p>
                              My name is Muhammad Asim. I am a IT graduate from Pir Mehr Ali Shah Arid University PMAS.I am experienced web developer. I am working as freelancer on different online platforms. I am working in following technologies.
                ...
                <div class="education" id="education">
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <span>2014 <i>to</i> 2018</span>
                                    <h3>Bachelor of Information and Technology</h3>
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <span>2012<i>to</i>2014</span>
                ...
                <div class="experience" id="experience">
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="exp-col">
                                    <span>2019<i>to</i>2021</span>
                                    <h3>Data Analyst</h3>
                                    <h4>Azan Enterprises</h4>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="contact-info">
                                    <p><i class="fa fa-user"></i>Muhammad Asim</p>
                                    <p><i class="fa fa-tag"></i>Web Designer & Developer</p>
                                    <p><i class="fa fa-envelope"></i><a href="mailto:info@example.com">muhammadasim2222@yahoo.com</a></p>
                                    <p><i class="fa fa-phone"></i><a href="tel:+1234567890">03235493448</a></p>
